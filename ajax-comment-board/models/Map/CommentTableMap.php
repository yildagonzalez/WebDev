...
class CommentTableMap extends TableMap
{
     ...
     */
    const COL_CREATE_TIME = 'comment.create_time';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'CreateTime', 'AuthorId', 'Body', ),
        self::TYPE_CAMELNAME     => array('id', 'createTime', 'authorId', 'body', ),
        self::TYPE_COLNAME       => array(CommentTableMap::COL_ID, CommentTableMap::COL_CREATE_TIME, CommentTableMap::COL_AUTHOR_ID, CommentTableMap::COL_BODY, ),
        self::TYPE_FIELDNAME     => array('id', 'create_time', 'author_id', 'body', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'CreateTime' => 1, 'AuthorId' => 2, 'Body' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'createTime' => 1, 'authorId' => 2, 'body' => 3, ),
        self::TYPE_COLNAME       => array(CommentTableMap::COL_ID => 0, CommentTableMap::COL_CREATE_TIME => 1, CommentTableMap::COL_AUTHOR_ID => 2, CommentTableMap::COL_BODY => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'create_time' => 1, 'author_id' => 2, 'body' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentTableMap::COL_CREATE_TIME);
