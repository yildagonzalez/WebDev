...
abstract class Comment implements ActiveRecordInterface
{
    ...
    public function setCreateTime($v)
    {
        ...
        if ($this->create_time !== null || $dt !== null) {
            if ($this->create_time === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->create_time->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CommentTableMap::COL_CREATE_TIME] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CommentTableMap::translateFieldName('CreateTime', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CommentTableMap::translateFieldName('Body', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_CREATE_TIME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_CREATE_TIME)) {
            $criteria->add(CommentTableMap::COL_CREATE_TIME, $this->create_time);
        }
        if ($this->isColumnModified(CommentTableMap::COL_AUTHOR_ID)) {
    ...
    {
        if ($this->aUser === null && ($this->author_id != 0)) {
