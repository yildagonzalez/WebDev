 ...
 * @method     ChildCommentQuery orderByCreateTime($order = Criteria::ASC) Order by the create_time column
 ...
 * @method     ChildCommentQuery groupByCreateTime() Group by the create_time column
 ...
 * @method     ChildComment findOneByCreateTime(string $create_time) Return the first ChildComment filtered by the create_time column
 ...
 * @method     ChildComment requireOneByCreateTime(string $create_time) Return the first ChildComment filtered by the create_time column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildComment[]|ObjectCollection findByCreateTime(string $create_time) Return ChildComment objects filtered by the create_time column
...
abstract class CommentQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, create_time, author_id, body FROM comment WHERE id = :p0';
        try {
    ...
    public function filterByCreateTime($createTime = null, $comparison = null)
    {
        if (is_array($createTime)) {
            ...
            if (isset($createTime['min'])) {
                $this->addUsingAlias(CommentTableMap::COL_CREATE_TIME, $createTime['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createTime['max'])) {
                $this->addUsingAlias(CommentTableMap::COL_CREATE_TIME, $createTime['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CommentTableMap::COL_CREATE_TIME, $createTime, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \User) {
            ...
            return $this
                ->addUsingAlias(CommentTableMap::COL_AUTHOR_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
